...
import { employeeAttendenceListColumns } from "../../../utils/tablecolumns";
import { theme } from "../../../theme/AppTheme";
import { EmployeeAttendenceEntryModel } from "../../../models/Model";
...
const EmployeeAttendenceEntryList = () => {
    ...
    const [employeeAttendenceEntryList, setEmployeeAttendenceEntryList] = useState<Array<EmployeeAttendenceEntryModel>>([]);
    const [employeeAttendenceEntryListTemp, setEmployeeAttendenceEntryListTemp] = React.useState<Array<any>>([]);
            ...
            .then((response: any) => {
                if (response.data && response.data.code === 200) {
                    if (response.data.data) {
                        ...
                        setEmployeeAttendenceEntryList(arrList);
                        setEmployeeAttendenceEntryListTemp(arrList);
                        // if (type !== "") {
            ...
            <Container maxWidth="lg">
                <Grid container spacing={{ xs: 1, md: 2 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                    <Grid item xs={4} sm={8} md={12}>
                        <Typography variant="h4">EMPLOYEE ATTENEDENCE ENTRY LIST</Typography>
                    </Grid>
                </Grid>
                ...
                <Grid item xs={4} sm={8} md={12}>
                    {loading ? (
                        ...
                        <div style={{ height: 500, width: "100%", marginBottom: "20px" }}>
                            {employeeAttendenceEntryList.length === 0 ? (
                                // <Grid>
                                ...
                                <>
                                    ...
                                    <DataGrid
                                        ...
                                        autoHeight={true}
                                        rows={employeeAttendenceEntryListTemp}
                                        columns={employeeAttendenceListColumns}
                                        pageSize={pageSize}
                                        ...
                                        onCellClick={(param, e: React.MouseEvent<HTMLElement>) => {
                                            ...
                                            if (param.field === 'action') {
                                                ...
                                                const arrActivity = [...employeeAttendenceEntryList];
                                                let a: EmployeeAttendenceEntryModel | undefined = arrActivity.find((el) => el.id === param.row.id);
                                            }
                                        }}
                                        sx={{
...
export default EmployeeAttendenceEntryList;
