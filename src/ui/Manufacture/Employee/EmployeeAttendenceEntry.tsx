...
import { employeeAttendenceColumns } from "../../../utils/tablecolumns";
import { theme } from "../../../theme/AppTheme";
import { EmployeeMarkAttendenceModel } from "../../../models/Model";
...
const EmployeeAttendenceEntry = () => {
    ...
    const [employeeAttendenceList, setEmployeeAttendenceList] = useState<Array<EmployeeMarkAttendenceModel>>([]);
    const [employeeAttendenceListTemp, setEmployeeAttendenceListTemp] = React.useState<Array<any>>([]);
            ...
            .then((response: any) => {
                if (response.data && response.data.code === 200) {
                    if (response.data.data) {
                        ...
                        setEmployeeAttendenceList(arrList);
                        setEmployeeAttendenceListTemp(arrList);
                        // if (type !== "") {
        ...
        <Box sx={{ mt: 11 }}>
            ...
            <Container maxWidth="lg">
                ...
                <Grid container spacing={{ xs: 1, md: 2 }} columns={{ xs: 4, sm: 10, md: 15 }}>
                    <Grid item sm={4}>
                        <label><label style={{ color: "#ff0000" }}>*</label>Date of Attendence</label>
                    </Grid>
                    <Grid item sm={4}>
                            ...
                            {employeeAttendenceList.length === 0 ? (
                                ...
                                <>
                                    ...
                                    <DataGrid
                                        ...
                                        autoHeight={true}
                                        rows={employeeAttendenceListTemp}
                                        columns={employeeAttendenceColumns}
                                        pageSize={pageSize}
                                        ...
                                        onCellClick={(param, e: React.MouseEvent<HTMLElement>) => {
                                            ...
                                            if (param.field === 'action') {
                                                ...
                                                const arrActivity = [...employeeAttendenceList];
                                                let a: EmployeeMarkAttendenceModel | undefined = arrActivity.find((el) => el.id === param.row.id);
                                            }
                                        }}
                                        sx={{
...
export default EmployeeAttendenceEntry;
