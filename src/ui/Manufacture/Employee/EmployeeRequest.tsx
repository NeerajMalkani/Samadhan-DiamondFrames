import {
  ...
  import { employeeRequestColumns } from "../../../utils/tablecolumns";
  import { theme } from "../../../theme/AppTheme";
  import {  EmployeeRequestModel } from "../../../models/Model";
  ...
  const EmployeeRequest = () => {
    ...
    const [employeeRequestList, setEmployeeRequestList] = useState<Array<EmployeeRequestModel>>([]);
    const [employeeRequestListTemp, setEmployeeRequestListTemp] = React.useState<Array<any>>([]);
        ...
        .then((response: any) => {
          if (response.data && response.data.code === 200) {
            if (response.data.data) {
              ...
              setEmployeeRequestList(arrList);
              setEmployeeRequestListTemp(arrList);
              // if (type !== "") {
        ...
        <Container maxWidth="lg">
          <Grid container spacing={{ xs: 1, md: 2 }} columns={{ xs: 4, sm: 8, md: 12 }}>
            ...
            <Grid item xs={4} sm={8} md={12}>
              <Typography variant="h4">EMPLOYEE REQUEST DETAILS</Typography>
            </Grid>
                ...
                {employeeRequestList.length === 0 ? (
                  ...
                  <>
                    ...
                    <DataGrid
                      ...
                      autoHeight={true}
                      rows={employeeRequestListTemp}
                      columns={employeeRequestColumns}
                      pageSize={pageSize}
                      ...
                      onCellClick={(param, e: React.MouseEvent<HTMLElement>) => {
                        ...
                        if (param.field === 'action') {
                          ...
                          const arrActivity = [...employeeRequestList];
                          let a: EmployeeRequestModel | undefined = arrActivity.find((el) => el.id === param.row.id);
