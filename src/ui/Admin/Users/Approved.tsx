...
import { ApprovredModel } from "../../../models/Model";
...
const Approved = () => {
  ...
  const [approvedNamesList, setApprovedNamesList] = useState<Array<ApprovredModel>>([]);
  ...
  const onChangeSearch = (query: string) => {
    ...
    if (query === "") {
      ...
      setApprovedNamesListTemp(
        approvedNamesList.filter((el: ApprovredModel) => {
                      ...
                      onCellClick={(param, e: React.MouseEvent<HTMLElement>) => {
                        ...
                        if (param.field === 'action') {
                          ...
                          const arrActivity = [...approvedNamesList];
                            let a: ApprovredModel | undefined =
                        ...
                        // else if (param.field === ' ') {
                        //   const arrActivity = [...approvedNamesList];
                        //   let a: ApprovredModel | undefined = arrActivity.find((el) => el.id === param.row.id);
