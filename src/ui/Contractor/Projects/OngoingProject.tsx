...
import { ongoingProject } from "../../../utils/tablecolumns";
...
interface TabPanelProps {
  ...
  const dummy = [
    {id:1,by_project:"General User Enquiry Wise",project_name:"ANNA NAGAR",contact:"Khan Anas & 9003168209",action:"Accept"},
