...
import { completedProject } from "../../../utils/tablecolumns";
...
interface TabPanelProps {
  ...
  const dummy = [
    {id:1,by_project:"General User Enquiry Wise",project_name:"ANNA NAGAR",contact:"Khan Anas & 9003168209"},
    {id:2,by_project:"Contractor Design Wise",project_name:"---",contact:" -- & --"}  
