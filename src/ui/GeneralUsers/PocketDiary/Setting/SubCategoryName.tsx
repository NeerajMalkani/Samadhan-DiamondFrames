...
import { subCategoryNameColumns } from "../../../../utils/tablecolumns";
import { theme } from "../../../../theme/AppTheme";
import { ModeTypeModel,CategoryNameModel,SubCategoryNameModel } from "../../../../models/Model";
                     ...
                     <NoData Icon={<ListIcon sx={{ fontSize: 72, color: "red" }} />} height="auto" text="No data found" secondaryText="" isButton={false} />
                      ...
                      <>
                        ...
                        <DataGrid
                          ...
                          columns={subCategoryNameColumns}
                          pageSize={pageSize}
                          ...
                          onCellClick={(param, e: React.MouseEvent<HTMLElement>) => {
                            ...
                            let a: SubCategoryNameModel | undefined = arrActivity.find((el) => el.id === param.row.id);
