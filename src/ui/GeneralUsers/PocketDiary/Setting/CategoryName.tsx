...
import { categoryNameColumns } from "../../../../utils/tablecolumns";
import { theme } from "../../../../theme/AppTheme";
import { ModeTypeModel,CategoryNameModel } from "../../../../models/Model";
...
const CategoryName = () => {
  ...
  const [categoryList, setcategoryList] =useState<Array<CategoryNameModel>>([]);//React.useContext(DataContext).activityNamesList;
                      ...
                      <>
                        ...
                        <DataGrid
                          ...
                          onCellClick={(param, e: React.MouseEvent<HTMLElement>) => {
                            ...
                            let a: CategoryNameModel | undefined = arrActivity.find((el) => el.id === param.row.id);
