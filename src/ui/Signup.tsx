...
const SignupPage = () => {
    ...
    return (
        <Box height="100vh" className="flex-center">
            <Paper className="padding-32 flex-center flex-column"
                sx={{
                    minWidth: { sm: 480 },
                    ...
                    <Grid>
                        <Box display="flex" flexDirection="row">
                            <TextField
                                variant="filled"
                                size="small"
                                value={otp1} onChange={(e) => onOTP1Changed(e.target.value)}
                                sx={{ mb: 2, width: 48, height: 48, mr: 1 }}
                            />
                            <TextField
                                variant="filled"
                                size="small"
                                value={otp2} onChange={(e) => onOTP2Changed(e.target.value)}
                                sx={{ mb: 2, width: 48, height: 48, mr: 1 }}
                            />
                            <TextField
                                variant="filled"
                                size="small"
                                value={otp3} onChange={(e) => onOTP3Changed(e.target.value)}
                                sx={{ mb: 2, width: 48, height: 48, mr: 1 }}
                            />
                            <TextField
                                variant="filled"
                                size="small"
                                value={otp4} onChange={(e) => onOTP4Changed(e.target.value)}
